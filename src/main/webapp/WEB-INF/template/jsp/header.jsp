<header
	...
	<div class="navbar-header aside-md dk">
		<a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen"
			...
			src="images/logo.png" class="m-r-sm" alt="scale"> <span
	...
	<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
		<li class="hidden-xs"><a href="#" class="dropdown-toggle"
			data-toggle="dropdown"> <i class="i i-chat3"></i> <span
				class="badge badge-sm up bg-danger count"
			...
			<section class="dropdown-menu aside-xl animated flipInY">
				<section class="panel bg-white">
					...
					<div class="list-group list-group-alt">
						<a href="#" class="media list-group-item" style="display: block;"><span
							...
							<small class="text-muted">1 minutes ago</small></span></a> <a href="#"
