...
public class FriendRequest  implements java.io.Serializable {
    ...
    public FriendRequest(FriendRequestId id, UserProfile userprofileByReceiverId, UserProfile userprofileBySenderId) {
        this.id = id;
        this.userprofileByReceiverId = userprofileByReceiverId;
        this.userprofileBySenderId = userprofileBySenderId;
    }
    public FriendRequest(FriendRequestId id, UserProfile userprofileByReceiverId, UserProfile userprofileBySenderId, Date created) {
       this.id = id;
       this.userprofileByReceiverId = userprofileByReceiverId;
       this.userprofileBySenderId = userprofileBySenderId;
