 ...
 */
@Entity
@Table(name = "membership", catalog = "diary_v2")
public class Membership implements java.io.Serializable {
	...
	public Membership(int idmembership, Date createdate,
			String confirmationToken, Boolean isConfirmed,
			Date lastPasswordFailureDate,
			Integer passwordFailuresSinceLastSuccess, Date passwordChangedDate,
	...
	public void setPasswordFailuresSinceLastSuccess(
			Integer passwordFailuresSinceLastSuccess) {
		this.passwordFailuresSinceLastSuccess = passwordFailuresSinceLastSuccess;
	}
